<?php if($paginator->hasPages()): ?>
    <nav class="d-flex justify-items-center justify-content-between">
        <div class="d-flex justify-content-between flex-fill d-sm-none">
            <ul style="font-size: " class="pagination">
        ...
        <div class="pagination_style d-none flex-sm-fill d-sm-flex align-items-sm-center justify-content-sm-between">
            <div>
...
<?php endif; ?>
<?php /**PATH C:\xampp2\htdocs\projects\hraiz_accounting\resources\views/vendor/pagination/bootstrap-5.blade.php ENDPATH**/ ?>