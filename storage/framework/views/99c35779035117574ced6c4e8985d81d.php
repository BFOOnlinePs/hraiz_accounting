    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form action="<?php echo e(route('accounting.orders_sales.order_sales_pdf', ['price_offer_id' => $data->id])); ?>">
                    <?php echo csrf_field(); ?>
                    <div class="row">
                        <div class="col-md-12">
...
<?php /**PATH C:\xampp2\htdocs\projects\hraiz_accounting\resources\views/admin/accounting/orders_sales/modals/order_sales_print_modal.blade.php ENDPATH**/ ?>