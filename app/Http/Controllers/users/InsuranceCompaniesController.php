...
class InsuranceCompaniesController extends Controller
{
    public function index()
    {
        ...
        return view('admin.users.insurance_companies.index', ['data' => $data]);
    }

    public function add()
    {
        return view('admin.users.insurance_companies.add');
    }
    ...
    public function create(Request $request)
    {
        ...
        if ($data->save()) {
            return redirect()->route('users.insurance_companies.index')->with(['success' => 'تم اضافة البيانات بنجاح']);
        } else {
    ...
    public function edit($id)
    {
        ...
        return view('admin.users.insurance_companies.edit', ['data' => $data,'user_role'=>$user_role]);
    }
    ...
    public function update($id, Request $request)
    {
        ...
        $data->user_iban_number = $request->user_iban_number;
        if ($data->save()) {
            return redirect()->route('users.insurance_companies.edit', ['id', $id])->with(['success' => 'تم اضافة البيانات بنجاح']);
        } else {
            return redirect()->back()->withInput();
        }
...
//        }
        return view('admin.users.insurance_companies.details', ['data' => $data, 'company_contact_person' => $company_contact_person]);
    }
