            ...
            <ul class="navbar-nav">
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        ...
                        <li><a href="{{ route('category.index') }}" class="dropdown-item">مجموعات الأصناف</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        <li><a href="{{route('users.employees.index')}}" class="dropdown-item">الموظفين</a></li>
                ...
                <li class="nav-item dropdown">
                    ...
                    <ul aria-labelledby="dropdownSubMenu1" class="dropdown-menu border-0 shadow">
                        ...
                        <li><a href="{{ route('reports.financial_report.financial_report_index') }}" class="dropdown-item">التقارير المالية</a></li>
...
{{--                        <li><a href="{{ route('tasks_type.index') }}" class="dropdown-item">أنواع المهام</a></li>--}}
                        ...
                        <li><a href="{{ route('order_status.index') }}" class="dropdown-item">حالات الطلبيات</a></li>
