                        ...
                        <div class="col-md-12">
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select onchange="get_invoices_for_client(this.value)" class="form-control select2bs4" name="client_id_with_invoice" id="client_id">
                            ...
                            <div style="display: none" id="with_not_invoice">
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <select onchange="selected_client_with_not_invoices(this.value)" class="form-control search_input select2bs4" name="client_id_with_not_invoice" id="client_id_with_no_invoices">
                                                <option value="">اختر عميل ...</option>
                                                @foreach($clients as $key)
                                                    <option value="{{ $key->id }}">{{ $key->name }}</option>
                                                @endforeach
