                        ...
                        <tr id="item_row_{{ $key->id }}">
                            ...
                            <td>
                                <input style="margin: 0" class="input form-control text-center"
                                    ...
                                    onchange="edit_inputs_from_invoice({{ $key->id }},this.value,'qty')"
                                    type="text" value="{{ $key->quantity ?? 1 }}">
                            </td>
                            <td>
                                <input style="margin: 0" class="input form-control text-center"
                            ...
                            <td>
                                <input style="margin: 0" class="input form-control text-center"
                                    @if ($invoice->status == 'stage') disabled @endif style="width: 40px"
                                    placeholder="%"
                    ...
                    <table class="table">
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>
                                    <button @if ($invoice->status == 'stage') disabled @endif type="button"
                                        class="btn btn-info btn-sm rounded-circle" data-toggle="modal"
