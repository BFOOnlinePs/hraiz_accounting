...
@section('content')
                        ...
                        <div class="col-md-9">
                            <div class="row ml-2 w-100">
                                <a class="btn btn-sm btn-light col-md-3 col-12 m-1 p-2"
                                    href="{{ route('accounting.purchase_invoices.new_invoices_index') }}"><span
                                        class="fa fa-plus"></span>&nbsp&nbsp<span>فاتورة جديدة</span></a>
                                ...
                                <a class="btn btn-danger btn-sm col-md-3 col-12 m-1 p-2"
                                    href="{{ route('accounting.purchase_invoices.archive_order') }}">
    ...
    <div class="modal fade" id="modal-lg">
        <div class="modal-dialog modal-xl">
            <form action="{{ route('accounting.purchase_invoices.create_purchase_invoices_from_order') }}" method="post"
                            ...
                            <div class="col-md-8">
                                <div class="form-group">
                                    ...
                                    <input onkeyup="search_order_ajax()" id="input_search" type="text"
                                        class="form-control" placeholder="بحث عن طلبية شراء">
...
@section('script')
    ...
    <script>
        function search_order_ajax(page) {
            ...
            $.ajax({
                url: '{{ route('accounting.purchase_invoices.search_order_ajax') }}',
                method: 'post',
                headers: headers,
                data: {
        ...
        function invoice_table_index_ajax(page) {
            ...
            $.ajax({
                url: '{{ route('accounting.purchase_invoices.invoice_table_index_ajax') }}',
                method: 'post',
                headers: headers,
                data: {
