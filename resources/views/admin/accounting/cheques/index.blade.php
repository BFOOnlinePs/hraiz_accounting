                    ...
                    <div class="row">
                        <div class="col">
                            <div class="form-group">
                                ...
                                <input type="text" onkeyup="list_cheques_ajax()" class="form-control" id="client_name" name="client_name" placeholder="اسم الزبون">
                            </div>
                        </div>
                        <div class="col">
                            <div class="form-group">
                                <label for="">نوع الشيك</label>
                                <select onchange="list_cheques_ajax()" name="check_type" id="" class="form-control">
                        ...
                        <div class="col">
                            <div class="form-group">
                                ...
                                <select onchange="list_cheques_ajax()" name="check_status" id="" class="form-control">
                                    <option value="">جميع الشيكات</option>
