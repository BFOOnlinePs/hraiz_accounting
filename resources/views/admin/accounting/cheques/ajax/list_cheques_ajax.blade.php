        ...
        @else
            @foreach($data as $key)
                <tr>
                    ...
                    <td>
                        <select onchange="update_check_type_ajax({{ $key->id }} , this.value)" class="form-control" name="" id="">
...
{{--                        @endif--}}
                    ...
                    <td>
                        <select onchange="update_check_status({{ $key->id }}, this.value )" class="form-control" name="" id="">
                            ...
                            <option @if($key->check_status == 'under_collection') selected @endif value="under_collection">في التحصيل</option>
                            <option @if($key->check_status == 'returned') selected @endif value="returned">راجع</option>
                            <option @if($key->check_status == 'portfolio') selected @endif value="portfolio">في المحفظة</option>
                        </select>
