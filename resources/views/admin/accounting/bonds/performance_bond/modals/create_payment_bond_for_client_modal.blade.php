                ...
                <ul class="nav nav-tabs" id="custom-content-below-tab" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="custom-content-below-cash-tab" data-toggle="pill"
                            href="#custom-content-below-cash" role="tab" aria-controls="custom-content-below-cash"
                            aria-selected="false">كاش</a>
                    </li>
                    <li class="nav-item">
                        <a class="nav-link" id="custom-content-below-cheque-tab" data-toggle="pill"
                            href="#custom-content-below-cheque" role="tab"
                            aria-controls="custom-content-below-cheque" aria-selected="false">شيك</a>
                    </li>
                </ul>
                <div class="tab-content" id="custom-content-below-tabContent">
                    <div class="tab-pane active show fade" id="custom-content-below-cash" role="tabpanel"
                        aria-labelledby="custom-content-below-cash-tab">
                        <form class="row mt-3"
                    ...
                    <div class="tab-pane fade" id="custom-content-below-cheque" role="tabpanel"
                        aria-labelledby="custom-content-below-cheque-tab">
                        ...
                        <form class="row" id=""
                            ...
                            <div class="col-md-12 mt-3">
                                <div class="form-group">
                                    <button type="button" onclick="add_check_for_client('')"
                                        class="btn btn-sm btn-success"><span class="fa fa-plus"></span>&nbsp;<span>من
                                            دفتري</span></button>
                            ...
                            <div class="col-md-12">
                                <div class="row" id="add_check_for_client_div">

                                </div>
                            </div>
                            <div class="col-md-12" style="display: none;" id="submit_button_client">
