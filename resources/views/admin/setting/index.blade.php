...
@section('content')
    <div class="row">
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <a href="{{ route('accounting.texes.index') }}" style="text-decoration: none" class="text-dark">
                <div class="info-box shadow-none">
                    <span class="info-box-icon"><i class="fa fa-cog"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text text-center pt-3">الضرائب</span>
                        {{--                        <span class="info-box-number">None</span>--}}
                    </div>
                </div>
            </a>
        ...
        <div class="col-md-3 col-sm-6 col-12">
            <a href="{{ route('setting.machine.setting_index') }}" style="text-decoration: none" class="text-dark">
                <div class="info-box shadow-none">
                    <span class="info-box-icon"><i class="fa fa-list"></i></span>
                    <div class="info-box-content">
                        <span class="info-box-text text-center pt-3">الالات</span>
                        {{--                        <span class="info-box-number">None</span>--}}
                    </div>
                </div>
            </a>
