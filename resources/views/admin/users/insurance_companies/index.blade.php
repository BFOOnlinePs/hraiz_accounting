...
@section('content')
    <div class="row">
                                    ...
                                    <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                                        ...
                                        @foreach($data as $key)
                                            <tr>
                                                ...
                                                <td>
                                                    <a class="btn btn-success btn-sm" href="{{ route('users.insurance_companies.edit',['id'=>$key->id]) }}"><span class="fa fa-edit"></span></a>
                                                    <a class="btn btn-dark btn-sm" href="{{ route('users.insurance_companies.details',['id'=>$key->id]) }}"><span class="fa fa-search"></span></a>
                                                </td>
                                            </tr>
                                        @endforeach
                                        </tbody>
        ...
        <div class="col-md-2">
            <div class="row">
                <div class="col-md-12">
                    <a href="{{ route('users.insurance_companies.add') }}" class="btn form-control btn-dark mb-2">اضافة شركة تأمين</a>
