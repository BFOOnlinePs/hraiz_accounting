                                ...
                                @foreach($price_offer as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td>
                                                <button onclick="openModalForEdit('price_offer',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($anchor as $key)
                                    @if(!empty($key->award_note))
                                        <tr>
                                            <td>ترسية</td>
                                            <td>
                                                ترسية عرض بتاريخ - <span>{{ $key->created_at }}</span>
                                            </td>
                                            <td>
                                                {{ $key->award_note }}
                                            </td>
                                            <td>
                                                <button onclick="openModalForEdit('anchor',{{ $key->id }},'{{ $key->award_note }}')" href="" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($cash_payments as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td> {{ $key->notes }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('cash_payment',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($letter_bank as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td> {{ $key->notes }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('letter_bank',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                        ...
                                        @if(!empty($key['letter_bank_modification']))
                                            @if(!empty($child->notes))
                                                <tr>
                                                    ...
                                                    <td> {{ $child->notes }}</td>
                                                    <td>
                                                        <button onclick="openModalForEdit('letter_bank_modification',{{ $child->id }},'{{ $child->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($shipping as $key)
                                    @if(!empty($key->note))
                                        <tr>
                                            ...
                                            <td> {{ $key->note }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('shipping',{{ $key->id }},'{{ $key->note }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($insurance as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td> {{ $key->notes }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('insurance',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($clerance as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td> {{ $key->notes }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('clearance',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($delivery as $key)
                                    @if(!empty($key->notes))
                                        <tr>
                                            ...
                                            <td> {{ $key->notes }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('delivery',{{ $key->id }},'{{ $key->notes }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
                                ...
                                @foreach($order_notes as $key)
                                    @if(!empty($key->note_text))
                                        <tr>
                                            ...
                                            <td> {{ $key->note_text }}</td>
                                            <td>
                                                <button onclick="openModalForEdit('order_notes',{{ $key->id }},'{{ $key->note_text }}')" class="btn btn-success btn-sm"><span class="fa fa-edit"></span></button>
