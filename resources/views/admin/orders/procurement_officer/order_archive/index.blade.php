...
@section('content')
    ...
    <div class="card">
        ...
        {{-- <div class="card-header">
            <h3 class="text-center">ارشيف الطلبات</h3>
        </div> --}}
    ...
    <div class="modal fade" id="modal-reference_number">
        <div class="modal-dialog modal-default">
            <form action="{{ route('order_archive.update_reference_number') }}" method="post"
    ...
    <div class="modal fade" id="modal-show_due_date">
        <div class="modal-dialog modal-default">
            <form action="{{ route('order_archive.update_due_date') }}" method="post"
                  enctype="multipart/form-data">
                @csrf
...
@section('script')
    ...
    <script>
        ...
        function updateOrderStatus(order_id,order_status_id) {
