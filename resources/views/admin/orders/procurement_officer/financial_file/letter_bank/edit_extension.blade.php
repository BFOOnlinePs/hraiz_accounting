...
@section('content')
    ...
    <div class="card">
        <div class="card-body">
            <form action="{{ route('procurement_officer.orders.financial_file.update_extension') }}" method="post" enctype="multipart/form-data">
                @csrf
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        <input class="form-control date_format" name="new_due_date" type="text" value="{{ $data->new_due_date }}">
                    </div>
                </div>
                ...
                <div class="col-md-12">
                    <div class="form-group">
                        ...
                        @if(!empty($data->attachment))
                            ...
                            <button type="button" onclick="viewAttachment('{{ asset('storage/attachment/'.$data->attachment) }}')" href="" class="btn btn-success btn-sm" data-toggle="modal"
