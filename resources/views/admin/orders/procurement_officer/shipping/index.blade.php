                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @if(!empty($key->Initial_bill_of_lading))
                                        ...
                                        <button onclick="viewAttachment('{{ asset('storage/attachment/'.$key->Initial_bill_of_lading) }}')" href="" class="btn btn-success btn-sm" data-toggle="modal"
                                                data-target="#modal-lg-view_attachment"><span
                                                class="fa fa-search"></span></button>
                            ...
                            <div class="col-md-4">
                                <div class="form-group">
                                    ...
                                    @if(!empty($key->actual_bill_of_lading))
                                        ...
                                        <button onclick="viewAttachment('{{ asset('storage/attachment/'.$key->actual_bill_of_lading) }}')" href="" class="btn btn-success btn-sm" data-toggle="modal"
                                                data-target="#modal-lg-view_attachment"><span
                                                class="fa fa-search"></span></button>
                                    @else
                                        لا يوجد ملف
