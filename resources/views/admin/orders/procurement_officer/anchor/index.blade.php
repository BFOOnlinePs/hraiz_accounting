                            ...
                            <div class="row">
                                ...
                                <div class="col-md-4 d-flex">
                                    @if(!empty($key->award_attachment))
                                        <a type="text"
                                           href="{{ asset('storage/attachment/'.$key->award_attachment) }}"
                                           download="attachment" class="btn btn-dark btn-sm mr-1"><span
                                                class="fa fa-download"></span><span> تحميل ملف الترسية</span></a>
                                        <button
                                            onclick="viewAttachment('{{ asset('storage/award_attachment/'.$key->award_attachment) }}')"
