                ...
                <div class="row">
                    ...
                    <div class="col">
                        <div class="form-group">
                            ...
                            <input onchange="data_table_ajax()" name="from" id="from_date" value="<?php echo '2023-01-01'?>" type="date" class="form-control">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
                            <label for="">الى تاريخ</label>
                            <input onchange="data_table_ajax()" name="to" id="to_date" value="<?php echo date('Y-m-d')?>" type="date" class="form-control">
                        </div>
                    </div>
                    <div class="col">
                        <div class="form-group">
