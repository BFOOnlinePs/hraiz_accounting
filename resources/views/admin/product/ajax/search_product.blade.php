<div class="table-responsive">
    <table style="width:100%" class="table text-center table-bordered table-striped">
        <thead>
            <tr>
                <th>صورة</th>
                <th>باركود</th>
                ...
                @foreach ($data as $key)
                    <tr>
                        ...
                        <td>
                            ...
                            <a href="{{ route('reports.products.product_pdf', ['product_id' => $key->id]) }}"
                                class="btn btn-sm btn-info"><span class="fa fa-print"></span></a>
                            <a href="{{ route('product.qrCode_product', ['id' => $key->id]) }}"
