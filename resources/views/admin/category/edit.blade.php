        ...
        <div class="card-body">
            <form action="{{ route('category.update',['id'=>$data->id]) }}" method="post" enctype="multipart/form-data">
                ...
                <div class="form-group">
                    ...
                    <input value="{{ $data->cat_name }}" class="form-control" required type="text" name="cat_name" placeholder="اكتب اسم التصنيف">
                </div>
                <div class="form-group">
                    <label for="">صورة التصنيف</label>
                    @if($data->cat_pic != '')
                        <img class="img-thumbnail" width="80" src="{{ asset('storage/category/'.$data->cat_pic) }}" alt="">
                    @endif
