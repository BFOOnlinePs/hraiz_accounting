...
@section('content')
        ...
        <div class="modal-dialog modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h4 class="modal-title">اضافة تقدير للتلكفة</h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>
                <form action="{{ route('estimation_cost_element.create') }}" method="post">
                    @csrf
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" name="name" placeholder="تقدير التكلفة">
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <div class="card">
        ...
        <div class="card-header">
            <h3 class="text-center">عناصر تقدير التكلفة</h3>
        </div>
                    ...
                    @endif
                        @foreach($data as $key)
                            <tr>
                                <td>{{ $key->name }}</td>
                                <td>
                                    <a class="btn btn-success btn-sm" href="{{ route('estimation_cost_element.edit',['id'=>$key->id]) }}"><span class="fa fa-edit mt-1"></span></a>
                                </td>
                            </tr>
                        @endforeach
                    </tbody>
