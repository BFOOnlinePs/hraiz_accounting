                    ...
                    <div class="inner">
                        ...
                        <div class="row mt-4">
                            <a class="btn btn-sm btn-warning col-lg col-12 m-1 p-2"
                                href="{{ route('accounting.purchase_invoices.index') }}">فواتير مشتريات</a>
                            <a class="btn btn-sm btn-warning col-lg col-12 m-1 p-2"
                                href="{{ route('orders.procurement_officer.order_index') }}">طلبيات شراء</a>
                            <a class="btn btn-sm btn-warning col-lg col-12 m-1 p-2"
                                href="{{ route('accounting.returns.index') }}">مردودات مشتريات</a>
                        </div>
                    </div>
                    <div class="icon">
                    ...
                    <div class="inner">
                        ...
                        <div class="row mt-4">
                            <a class="btn btn-sm btn-success col-lg col-12 m-1 p-2"
                                href="{{ route('accounting.sales_invoices.index') }}">فواتير مبيعات</a>
                            <a class="btn btn-sm btn-success col-lg col-12 m-1 p-2"
                                href="{{ route('price_offer_sales.index') }}">عروض اسعار بيع</a>
                            <a class="btn btn-sm btn-success col-lg col-12 m-1 p-2"
                                href="{{ route('accounting.returns.index') }}">مردود مبيعات</a>
                            <a class="btn btn-sm btn-success col-lg col-12 m-1 p-2"
                                href="{{ route('accounting.orders_sales.index') }}">طلبيات بيع</a>
                        </div>
                    </div>
                    <div class="icon">
            ...
            <div class="col-lg-6 col-12">
                <div class="small-box bg-dots-darker border border-danger pr-3 pt-4 pb-2">
                    <div class="inner">
                        ...
                        <h3>الأصناف</h3>
                        <div class="row mt-4">
                            <a class="btn btn-sm btn-danger col-lg col-12 m-1 p-2" href="{{ route('product.index') }}">قائمة
                                الأصناف</a>
                            <a class="btn btn-sm btn-danger col-lg col-12 m-1 p-2"
                                href="{{ route('units.index') }}">الوحدات</a>
                            <a class="btn btn-sm btn-danger col-lg col-12 m-1 p-2"
                                href="{{ route('category.index') }}">مجموعات الأصناف</a>
                        </div>
                    </div>
                    <div class="icon">
                    ...
                    <div class="inner">
                        ...
                        <div class="row mt-4">
                            <a class="btn btn-sm btn-info col-lg col-12 m-1 p-2"
                                href="{{ route('users.employees.index') }}">موظفين</a>
                            <a class="btn btn-sm btn-info col-lg col-12 m-1 p-2"
                                href="{{ route('users.supplier.index') }}">موردين</a>
                            <a class="btn btn-sm btn-info col-lg col-12 m-1 p-2"
                                href="{{ route('users.clients.index') }}">زبائن</a>
                        </div>
                    </div>
                    <div class="icon">
                                ...
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-dark btn-sm"
                                            href="{{ route('production.production_inputs.index', ['id' => $key->production_lines->id]) }}"><span
                ...
                <div class="modal-body p-5">
                    <div class="row">
                        <div class="col-md-12">
                            ...
                            <div class="d-inline">
                                <a href="{{ route('setting.first_term_balance.index') }}" class="btn btn-sm btn-success float-right">تحديث ارصدة اول المدة</a>
                            </div>
                        </div>
                        <div class="col-md-12">
                        ...
                        <div class="col-md-12">
                            <table class="table table-sm table-hover">
                                ...
                                <tbody>
                                    ...
                                    @if (empty($item['first_term_balance']))
                                    <tr>
