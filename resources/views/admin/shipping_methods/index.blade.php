...
@section('content')
    ...
    <button type="button" class="btn btn-dark mb-2" data-toggle="modal" data-target="#modal-lg">اضافة نوع الشحن
    </button>
    <div class="card">

        <div class="card-header">
            <h3 class="text-center">قائمة انوع الشحن</h3>
        </div>
                        ...
                        <table id="example1" class="table table-bordered table-striped dataTable dtr-inline"
                            ...
                            @foreach($data as $key)
                                <tr>
                                    ...
                                    <td>
                                        <a class="btn btn-success btn-sm" href="{{ route('shipping_methods.edit',['id'=>$key->id]) }}"><span class="fa fa-edit mt-1"></span></a>
                                    </td>
                                </tr>
                            @endforeach
                            </tbody>
