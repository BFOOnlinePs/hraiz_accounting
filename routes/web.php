        ...
        Route::group(['prefix' => 'procurement_officer'], function () {
            ...
            Route::group(['prefix' => 'orders'], function () {
                ...
                Route::group(['prefix'=>'product'],function(){
                    ...
                    Route::post('/product_list_pdf', [App\Http\Controllers\procurement_officer\ProductController::class, 'product_list_pdf'])->name('procurement_officer.orders.product.product_list_pdf');
